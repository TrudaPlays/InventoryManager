    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([id] = @Original_id) AND ([ProductName] = @O" +
                "riginal_ProductName) AND ([Category] = @Original_Category) AND ([Price] = @Origi" +
                "nal_Price) AND ([Quantity] = @Original_Quantity))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [id] = @id, [ProductName] = @ProductName, [Category] = @Category, [Price] = @Price, [Quantity] = @Quantity WHERE (([id] = @Original_id) AND ([ProductName] = @Original_ProductName) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT id, ProductName, Category, Price, Quantity FROM Products WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InventoryManager.Properties.Settings.Default.conn;
        }
        ...
        public virtual int Delete(int Original_id, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_Quantity) {
        ...
        public virtual int Insert(int id, string ProductName, string Category, decimal Price, int Quantity) {
        ...
        public virtual int Update(int id, string ProductName, string Category, decimal Price, int Quantity, int Original_id, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_Quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Category, decimal Price, int Quantity, int Original_id, string Original_ProductName, string Original_Category, decimal Original_Price, int Original_Quantity) {
