...
namespace InventoryManager {
    ...
    public partial class InventoryDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public ProductsRow AddProductsRow(int Id, string ProductName, string Category, decimal Price, decimal Quantity) {
...
namespace InventoryManager.InventoryDatabaseDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Id], [ProductName], [Category], [Price], [Quantity" +
                "]) VALUES (@Id, @ProductName, @Category, @Price, @Quantity);\r\nSELECT Id, Product" +
                "Name, Category, Price, Quantity FROM Products WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Id] = @Id, [ProductName] = @ProductName, [Category] = @Category, [Price] = @Price, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)));
SELECT Id, ProductName, Category, Price, Quantity FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InventoryManager.Properties.Settings.Default.InventoryDatabaseConnString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ProductName, Category, Price, Quantity FROM dbo.Products";
        ...
        public virtual int Delete(int Original_Id, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<decimal> Original_Quantity) {
        ...
        public virtual int Insert(int Id, string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<decimal> Quantity) {
        ...
        public virtual int Update(int Id, string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<decimal> Quantity, int Original_Id, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<decimal> Original_Quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<decimal> Quantity, int Original_Id, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<decimal> Original_Quantity) {
            return this.Update(Original_Id, ProductName, Category, Price, Quantity, Original_Id, Original_ProductName, Original_Category, Original_Price, Original_Quantity);
        }
    }
